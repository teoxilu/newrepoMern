    ...
    return (
        <tbody className='text-center'>
            <tr>
                ...
                <td className="text-light-on-surface w-[20%]" style={{verticalAlign:'middle'}}>{p.title}</td>
                <td className="bg-light-tertiary-container/50 text-light-on-primary-container w-[10%]" style={{verticalAlign:'middle'}}>
                    {numeral(p.price).format('0,0')} VND
                </td>
                <td className="text-light-on-surface w-[10%]" style={{verticalAlign:'middle'}}>{p.brand}</td>
                ...
                <td className="text-center max-w-[100px] bg-light-tertiary-container/50 w-[15%]" style={{verticalAlign:'middle'}}>
                    <input
                        type="number"
                ...
                <Dialog size='sm' handler={handleOpen} open={isOpenDialog}>
                    <DialogHeader className="text-light-on-surface flex items-center space-x-2">Delete selected product?</DialogHeader>
                    <DialogFooter>
                        <Button
                            variant="text"
